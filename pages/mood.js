...
export default function Mood({}) {
	const GetJoke = async () => {
		const result = await axios.get(
			'https://v2.jokeapi.dev/joke/Any?blacklistFlags=religious,political,racist,sexist,explicit&format=txt&type=single'
		);
			...
			<ContainerHolder>
				<Holder2>
					<TitleHolder>
						...
						<Text>
							Feeling a bit down? Start by using one of the tools
							below to help improve your mood
						</Text>
					</TitleHolder>
					...
					<CardHolder>
						...
						>
							...
							<p style={{ color: '#878FA2' }}>
								To begin Mindful Breathing start by clicking on
								the Breathe Tool and follow along.
							</p>
